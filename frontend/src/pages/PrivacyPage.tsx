    ...
    <div className={`page ${styles.legalPage}`}>
      ...
      <div className={styles.content}>
        ...
        <p>
          ...
          契約書テキストは分析処理のみに使用され、分析完了後にサーバーから即時削除されるため、個人情報として保存されることはありません。
        </p>
        ...
        <p>
          アップロードされた契約書テキストは、AI分析処理の実行にのみ使用されます。
          分析完了後、契約書テキストはサーバーから即時に削除され、データベースにも保存されません。
          分析レポートはRedisに24時間キャッシュされた後、自動的に削除されます。
        </p>
        ...
        <ul>
          ...
          <li>OpenAI, Inc. — 契約書テキストのAI分析処理のため（分析完了後にテキストは削除されます）</li>
        </ul>
