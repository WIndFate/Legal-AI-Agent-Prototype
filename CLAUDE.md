...
- Sharing should open a first-party share sheet before optional native share, generate a referral-tagged report URL behind the scenes, and present that flow as a polished result-sharing surface rather than a raw utility dialog. Copy-link and optional native share stay primary; preview-card save/download can remain as a secondary action.
